...
from .utils import ConfigLoader, remove_fields, print_tree
...
class PageIndexClient:
    ...
    def __init__(self, api_key: str = None, model: str = None, retrieve_model: str = None, workspace: str = None):
        ...
        elif not os.getenv("GEMINI_API_KEY") and os.getenv("CHATGPT_API_KEY"):
            os.environ["GEMINI_API_KEY"] = os.getenv("CHATGPT_API_KEY")
